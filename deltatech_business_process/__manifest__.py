...

{
    ...
    "depends": ["base", "mail", "portal", "deltatech_contact"],
    "data": [
    ...
    "assets": {
        "web.assets_frontend": [
            "deltatech_business_process/static/src/scss/business_project_sharing_frontend.scss",
        ],
        "deltatech_business_process.webclient": [
            ...
            "deltatech_business_process/static/src/business_project_sharing/**/*",
